...
function addDisclaimerSheet(wb: XLSX.WorkBook) {
  const ws = XLSX.utils.aoa_to_sheet([
    ["NOTICE — AI-Generated Draft"],
    [""],
    ["This workbook was generated by an AI assistant."],
    ["The Project Manager must review, validate, and take ownership of all content"],
    ["before sharing or use in any project context."],
    [""],
